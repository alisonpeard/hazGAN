...
ibtracs = pd.read_csv('/Users/alison/Documents/DPhil/multivariate/era5_data/ibtracs_dates.csv')
ibtracs['time'] = pd.to_datetime(ibtracs['time'])
dates = ibtracs['time']
ibtracs = ibtracs.set_index('time')
...
ax.set_title('TC {} {}'.format(ibtracs.loc[t0]['event'].capitalize(), t0))
print(Pa)
# %% example
