#!/bin/bash
#SBATCH --job-name=gen
#SBATCH --output=./gen_unif.out
#SBATCH --error=./gen_unif.err
...
OUTDIR="/data/ouce-opsis/spet5107/data/generated/uniform_minmax09"
NETWORK="/data/ouce-opsis/spet5107/data/00006-uniform_minmax09-low_shot-kimg300-color-translation-cutout/network-snapshot-000300.pkl"
